# 긍정/부정단어 개수 카운팅
# 추천/비추천 숙소 판단하기 : 근데 숙소별 정보를 가져오지않았는데도 이게 가능한지 확인 중
# 전남 전체 모텔 - 감성분석 코드
...
# 데이터 불러오기
mtdata = pd.read_csv('motel_list_last.json')
...
print(f"숙소 추천 여부: {recommendation}")

# 결과 출력 및 저장
print(mtdata)
mtdata.to_csv('../data/output3.csv', index=False)
